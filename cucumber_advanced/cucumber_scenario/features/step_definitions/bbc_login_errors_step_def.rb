...
And(/^I input the necessary details with the password details (.*)$/) do |ppost|
  bbc_register_page.fill_in_email('test@gmail.com')
  sleep 2
  bbc_register_page.fill_in_password('katie1234')
  sleep 2
  bbc_register_page.fill_in_postcode_field(post)
  sleep 1
  bbc_register_page.find_postcode_field.send_keys :tab
end
